...
/**
 * Created by KhanhNV10 on 29/03/2016.
 */
public class ColorPickerView extends View {
    ...
    public void setParams(Context c) {
        DisplayMetrics displayMetrics = c.getResources().getDisplayMetrics();
        float mWidth = displayMetrics.widthPixels;
        float mHeight = displayMetrics.heightPixels;
        if (mWidth < mHeight) {
            CENTER_X = (int)(mWidth/3);
            CENTER_Y = CENTER_X;
        } else {
            CENTER_X = (int)(mHeight/3);
            CENTER_Y = CENTER_X;
        }
        CENTER_RADIUS = CENTER_X/2;
        mPaint.setStrokeWidth(CENTER_X/3);
        mCenterPaint.setStrokeWidth(CENTER_X/4);
    }
